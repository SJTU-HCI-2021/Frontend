...
<!--            &lt;!&ndash; <div v-for="(item,i) in OutputContent" class="text item"> &ndash;&gt;-->
<!--            &lt;!&ndash; {{item }} &ndash;&gt;-->
<!--            &lt;!&ndash; </div> &ndash;&gt;-->
<!--          </el-card>-->
...
import RectDemo from '../components/RectDemo'
export default {
  name: "HomePage",
  components: { OldAudioView, AutoCameraView, AudioView, Record, DrawRect,RectDemo },
  data() {
    return {
      SearchInput: "",
      OutputContent: [],
